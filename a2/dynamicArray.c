...
{	
	...
	/* change the pointer to reference new array */
	*v = newArray;
}
...
TYPE getDynArr(DynArr *v, int pos)
{
	...
	/* FIXME: you must change this return value *FIXED*/
	return v->data[pos];
}
...
{
	/* FIXME: You will write this function *FIXED*/
	/* check if index position is legal and positive */
	assert(pos >= 0 && pos < v->size);
...
{
	/* FIXME: You will write this function *FIXED*/
	/* check is swap values are valid */
...
void removeAtDynArr(DynArr *v, int idx)
{
	...
	/* shift elements */
	for(indexArr = idx; indexArr < v->size; indexArr++){
		v->data[indexArr] = v->data[indexArr + 1];
	}
...
int isEmptyDynArr(DynArr *v)
{
	...
	/* FIXME:  You will change this return value *FIXED*/
	return 0;
}
